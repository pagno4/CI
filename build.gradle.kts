plugins {
    ...
    // Dokka permette di creare della documentazione
    ...
    // Plugin per poter firmare i pacchetti con firma digitale
    signing

    // Plugin per poter pubblicare il plugin su Maven Central
    `maven-publish`

    // Plugin del prof per preconfigurare la pubblicazione su Maven
...
// Tasks per javadoc: permette di impacchettare il SW
// Questo tasks non serve più perché è già eseguito nel plugin del prof 'publish-on-central'
// (và in conflitto)
...
// Configurazione per pubblicazione su Maven
// Questi sono tutti valori di default
publishOnCentral {
